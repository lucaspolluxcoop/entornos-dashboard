...
$ docker run --rm -v "${PWD}:/$(basename `pwd`)" -w "/$(basename `pwd`)" -it node:latest sh -c "yarn create nuxt-app ."

## (*) if the project exists change "yarn create nuxt-app ." for "yarn install" to create node_modules folder
