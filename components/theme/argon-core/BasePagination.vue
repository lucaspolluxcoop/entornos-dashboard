<template>
  ...
  >
    <li
      class="page-item prev-page cursor-pointer"
      :class="{ disabled: value === 1 }"
    >
      <a class="page-link" aria-label="Previous" @click="prevPage">
        <span aria-hidden="true"><fa icon="angle-left" /></span>
      </a>
    </li>
    <li
    ...
    <li
      class="page-item next-page cursor-pointer"
      :class="{ disabled: value === totalPages }"
    >
      <a class="page-link" aria-label="Next" @click="nextPage">
        <span aria-hidden="true"><fa icon="angle-right" /></span>
      </a>
    </li>
  </ul>
</template>
